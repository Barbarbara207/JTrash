...
public class CompHand3Model {
    ...
    /**
     * Costruttore della classe ComputerHand3Model
     */
    public CompHand3Model(ArrayList<CardModel> carte, int quanteVittorie) {
        this.carte = carte;
     ...
     * della mano del computer 3, permettendo alla View di rappresentarla correttamente
     */
    public String[] listaManoComp3() {
        ArrayList<String> stringManoComp3 = new ArrayList<>();
        for (CardModel carta : carte) {
            stringManoComp3.add(carta.getValore() + " of " + carta.getSegno() + " of " + carta.isScoperta());
        }
        stringManoComp3.add(0, "ManoComputer3");

        return stringManoComp3.stream().toArray(String[] :: new);
    }
